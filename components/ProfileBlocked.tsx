...
export default function ProfileBlockedComponents() {
  return (
    <>
      <View>
        <Flex
        ...
        >
          <View>
            <Heading level={4}>🚫 Jugadores bloqueados</Heading>
          </View>
        </Flex>
      </View>
      ...
      <View>
        <SearchField
          label="Buscar"
          placeholder="Buscar usuario a bloquear..."
        />
      ...
      <Table highlightOnHover variation="striped">
        <TableHead>
          <TableRow>
            ...
            <TableCell as="th">Bloqueado el</TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          <TableRow>
